...
public class Lobby implements CommandExecutor
{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) 
	{
		if (sender instanceof Player)
		{
			...
			if (args.length == 0)
				WorldUtil.queueWorldChange(player, WorldUtil.WorldType.LOBBY);
			else
			{
				ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Umiesz pisac?! Wystarczy napisac #ffc936/lobby!");

	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) 
	{
		if (sender instanceof Player)
		{
			...
			else
			{
				...
				{
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Kazdy slub powinien byc uroczysty, zadbaj o to, biorac slub na lobby serwera!");
				...
				if (player.getLocation().distance(WorldUtil.LOBBY_CHURCH) > 20)
				{
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Formalnosci ponad wszystko, najpierw udaj sie do kosciola!");
					VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
					VisualUtil.showPlayerParticle(player, Particle.FLAME);
					SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
					return true;
				...
				if (args.length >= 3)
				{
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Spokojnie, spokojnie, wpisz komende jeszcze raz, nie mozemy nadazyc za toba!");
					VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
					VisualUtil.showPlayerParticle(player, Particle.FLAME);
					SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
					return true;
				...
				if (args[0].equalsIgnoreCase("akceptuj"))
				{
					...
					{
						ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nie zdradzaj swojego partnera(ki), " + ChatUtil.returnPlayerColor(player) + DPlayerManager.getInstance().getMarry(player) + "!");
						VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
						VisualUtil.showPlayerParticle(player, Particle.FLAME);
						SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
						return true;
					...
					for (Player dplayer : Bukkit.getOnlinePlayers())
						if (dplayer.getName().equalsIgnoreCase(potencial_player))
						{
							...
							ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nic mi nie wiadomo o zadnym slubie!");
							VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
							VisualUtil.showPlayerParticle(player, Particle.FLAME);
							SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
							return true;
				...
				else if (args[0].equalsIgnoreCase("rozwod"))
				{
					...
					{
						ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#8c8c8cNawet nie jestes w zwiazku!");
						VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
						VisualUtil.showPlayerParticle(player, Particle.FLAME);
						SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
						return true;
					...
					for (Player dplayer : Bukkit.getOnlinePlayers())
						if (dplayer.getName().equalsIgnoreCase(potencial_player))
						{
							...
							{
								ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Wy nawet nie jestescie razem!");
								VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
								VisualUtil.showPlayerParticle(player, Particle.FLAME);
								SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
							}
					...
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Twoja milosc musi byc on-line!");
					VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
					VisualUtil.showPlayerParticle(player, Particle.FLAME);
					SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
					return true;
				...
				else if (args[0].equalsIgnoreCase("status"))
				{
					...
					{
						ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#8c8c8cTen gracz tu kiedykolwiek gral czy tak z dupy go podales?");
						VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
						VisualUtil.showPlayerParticle(player, Particle.FLAME);
						SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
						return true;
				...
				for (Player dplayer : Bukkit.getOnlinePlayers())
					if (dplayer.getName().equalsIgnoreCase(potencial_player))
					{
						...
						{
							ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nie mozesz byc w zwiazku sam ze soba narcyzie!");
							VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
							VisualUtil.showPlayerParticle(player, Particle.FLAME);
							SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
							return true;

	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) 
	{
		if (sender instanceof Player)
		{
			...
			if (args.length == 0)
				...
				{
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Miejsce, na ktore probujesz powrocic zostalo juz przez Ciebie uzyte lub odleglosc do niego jest zbyt mala!");
			...
			{
				ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Umiesz pisac?! Wystarczy napisac #ffc936/powrot!");
				VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
				VisualUtil.showPlayerParticle(player, Particle.FLAME);
				SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
			}

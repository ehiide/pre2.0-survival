    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        if (sender instanceof Player)
        {
            ...
            else
            {
                if (args.length > 2)
                {
                    ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Co kurwa?! Wpisz #ffc936/gang#fc7474 i nie pierdol!");
                ...
                if (args[0].equalsIgnoreCase("stworz"))
                    if (args.length > 1)
                    {
                        ...
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nazwa Twojego gangu moze miec od 3 do 5 znakow!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                        ...
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Masz za malo monet, aby stworzyc gang!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                        ...
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Gang o takiej nazwie juz istnieje!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                        ...
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Znajdujesz sie juz w gangu, wiec nie mozesz stworzyc nowego!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        }
                ...
                else if (args[0].equalsIgnoreCase("opusc"))
                {
                    if (GangManager.getInstance().getGang(player) == null)
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nie znajdujesz sie w zadnym gangu, wiec nie mozesz go opuscic!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                    }
                    ...
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#8c8c8cOdszedles od swojego gangu!");
                        ServerUtil.reloadContents(player);
                ...
                else if (args[0].equalsIgnoreCase("lider"))
                {
                    if (GangManager.getInstance().getGang(player) == null)
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Ziomek, Ty nawet nie masz gangu!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        return true;
                    ...
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Tylko lider moze dokonac zmiany lidera!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        return true;
                    ...
                    for (Player lider : Bukkit.getOnlinePlayers())
                        if (lider.getName().equalsIgnoreCase(potencial_lider))
                        {
                            ...
                            {
                                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Ten gracz nie jest w Twoim gangu!");
                                VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                                VisualUtil.showPlayerParticle(player, Particle.FLAME);
                                SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                                return true;
                            ...
                            {
                                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Jestes juz na stanowisku lidera!");
                                VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                                VisualUtil.showPlayerParticle(player, Particle.FLAME);
                                SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                                return true;
                ...
                else if (args[0].equalsIgnoreCase("info"))
                {
                    if (args.length > 1)
                    {
                       ...
                       if (!isExist)
                       {
                           ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nie ma takiego gangu na serwerze!");
                           VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                           VisualUtil.showPlayerParticle(player, Particle.FLAME);
                           SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                           return true;
                    ...
                    if (gang == null)
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nie nalezysz do zadnego gangu!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        return true;
                ...
                else if (args[0].equalsIgnoreCase("friendlyfire"))
                {
                    ...
                    if (!GangManager.getInstance().getLider(GangManager.getInstance().getGang(player)).equalsIgnoreCase(player.getName()))
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Musisz byc liderem gangu, aby zmienic to ustawienie!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        return true;
                    ...
                    ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#8c8c8cZmieniono ustawienie wzajemnego bicia na " + ChatUtil.isGangFriendlyFire(GangManager.getInstance().getGang(player)) + "#8c8c8c!");
                    return true;
                }
                else if (args[0].equalsIgnoreCase("wyrzuc"))
                {
                    ...
                    if (!GangManager.getInstance().getLider(GangManager.getInstance().getGang(player)).equalsIgnoreCase(player.getName()))
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Tylko lider moze wyrzucac czlonkow gangu!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        return true;
                    ...
                    for (Player kicker : Bukkit.getOnlinePlayers())
                        if (kicker.getName().equalsIgnoreCase(potencial_kicker))
                        {
                            ...
                            {
                                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Ten gracz nawet nie jest w Twoim gangu!");
                                VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                                VisualUtil.showPlayerParticle(player, Particle.FLAME);
                                SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                                return true;
                            ...
                            ServerUtil.reloadContents(player);
                            ServerUtil.reloadContents(kicker);
                            return true;
                        }
                ...
                else if (args[0].equalsIgnoreCase("zapros"))
                {
                    ...
                    for (Player dplayer : Bukkit.getOnlinePlayers())
                        if (dplayer.getName().equalsIgnoreCase(potencial_player))
                        {
                            ...
                            {
                                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Ten gracz posiada juz swoj gang!");
                                VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                                VisualUtil.showPlayerParticle(player, Particle.FLAME);
                                SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                                return true;
                            ...
                            {
                                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Ten gracz nalezy juz do Twoich szeregow w gangu!");
                                VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                                VisualUtil.showPlayerParticle(player, Particle.FLAME);
                                SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                                return true;
                    ...
                    for (Player dplayer : Bukkit.getOnlinePlayers())
                        if (dplayer.getName().equalsIgnoreCase(potencial_player))
                        {
                            if (DPlayerCloudManager.getGang(dplayer) == player)
                            {
                                ...
                                ChatManager.sendMessage(player, "#f83044&l» &cDolaczyles do gangu " + GangManager.getInstance().getGang(dplayer) + "!");
                            ...
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Miales gdzies dolaczyc? Moze czas minal, moze gracz wyslal juz zaproszenie komus innemu, ja nic nie wiem!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                ...
                else if (args[0].equalsIgnoreCase("tpall"))
                {
                    ...
                    if (!GangManager.getInstance().getLider(GangManager.getInstance().getGang(player)).equalsIgnoreCase(player.getName()))
                    {
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Tylko lider moze wywolac teleportacje wszystkich czlonkow!");
                        VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                        VisualUtil.showPlayerParticle(player, Particle.FLAME);
                        SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                        return true;
                ...
                else if (args[0].equalsIgnoreCase("baza"))
                {
                    ...
                    if (args.length == 1)
                    {
                        ...
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Twoj gang nie ma jeszcze ustawionej bazy!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                    ...
                    else
                    {
                        ...
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Nie rozumiem ani slowa! Sprobuj uzyc #ffc936/gang baza ustaw #fc7474i bedzie dobrze!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                        ...
                        if (!GangManager.getInstance().getLider(GangManager.getInstance().getGang(player)).equalsIgnoreCase(player.getName()))
                        {
                            ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Tylko lider moze ustawic lokalizacje bazy gangu!");
                            VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                            VisualUtil.showPlayerParticle(player, Particle.FLAME);
                            SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                            return true;
                        ...
                        ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#8c8c8cBaza Twojego gangu zostala zaktualizowana!");
                    }
                    return true;
                }

                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Co kurwa?! Wpisz #ffc936/gang #fc7474i nie pierdol!");
                VisualUtil.showDelayedTitle(player, "#fc7474✖", "", 0, 20, 20);
                VisualUtil.showPlayerParticle(player, Particle.FLAME);
                SoundUtil.playPlayerSound(player, Sound.BLOCK_ANVIL_DESTROY, 4, 4);
                return true;

		...
		if (sender instanceof Player)
		{
			...
			else
			{
				if (args.length <= 1)
				{
					...
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Koledze sie chyba strony pojebaly! Mozesz wybrac strone #ffc9361-7!");
				}
				else
				{
					ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#fc7474Umiesz pisac?! Wystarczy napisac #ffc936/craftingi (strona)!");
				}
